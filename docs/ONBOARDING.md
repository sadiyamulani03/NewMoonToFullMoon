...
8. **Send wallet address** — Copy your `mn_addr_preprod…` from Lace (Receive → Copy) → Paste it in the feedback form: https://docs.google.com/forms/d/e/1FAIpQLSdMZQVcwBSz4oQIHFUWWDdkxkBbyNo-wBMB7BiINVrQ70r9tw/viewform (or DM the coordinator). This counts you toward the 70 Preprod users (in `LAUNCH_USERS.md`).
