...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      incrementAndReveal: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`incrementAndReveal: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const amount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('incrementAndReveal',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._incrementAndReveal_0(context,
                                                    partialProofData,
                                                    amount_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      incrementAndReveal: this.circuits.incrementAndReveal
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('incrementAndReveal', new __compactRuntime.ContractOperation());
  ...
  _incrementAndReveal_0(context, partialProofData, amount_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
